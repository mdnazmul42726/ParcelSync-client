                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                        <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                            <div>
                                ...
                                <p className="mt-2 text-sm text-blue-500 ">hello@parcelsync.com</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-blue-500 ">Dhaka, Bangladesh</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-blue-500 ">+88 01700000001</p>
                            </div>
                        </div>
